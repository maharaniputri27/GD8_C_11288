...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <!-- To the right -->
            <div class="float-right d-none d-sm-inline"> GD8_C_11288 </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">AdminLTE.io</a>. All rights reserved.</strong>
        </footer>
    </div>
